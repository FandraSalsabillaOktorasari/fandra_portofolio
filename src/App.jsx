  ...
  const certifications = [
    {
      ...
      fileUrl: '/assets/certificates/Belajar_Dasar_Structured_Query_Language__SQL_.pdf',
    ...
    },
    {
      ...
      fileUrl: '/assets/certificates/Certified_Data_Analytics_with_Python.pdf'
    },
    {
      ...
      fileUrl: '/assets/certificates/Belajar_Dasar_AI.pdf',
    ...
    },
    {
      ...
      fileUrl: '/assets/certificates/Belajar_Dasar_Manajemen_Proyek.pdf',
    ...
    },
    {
      ...
      fileUrl: '/assets/certificates/Belajar_Dasar_Data_Science.pdf',
    ...
    },
    {
      ...
      fileUrl: '/assets/certificates/Belajar_Dasar_Visualisasi_Data.pdf'
    }
  ];
          ...
          <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-8 items-center w-full">
            <div>
              ...
              <div className="flex items-center gap-5 text-[#6B7280]">
                <a href="github.com/FandraSalsabillaOktorasari" className="hover:text-[#7C3AED] transition-colors flex items-center gap-2 text-sm">
                ...
                <a href="fandrakuliah@gmail.com" className="hover:text-[#7C3AED] transition-colors flex items-center gap-2 text-sm">
      ...
      <footer className="py-8 bg-[#1A1523] text-center border-t border-gray-800">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-2">
          ...
          <div className="flex gap-5">
            <a href="github.com/FandraSalsabillaOktorasari" className="text-sm text-[#9CA3AF] hover:text-[#A78BFA] transition-colors">Github</a>
